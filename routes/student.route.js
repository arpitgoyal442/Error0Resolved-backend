...
router.post("/acceptrequest/:studentId",acceptRequest);    // when stdent click on accept then here in req body we get { doubtid and debuggerid} so set debuggerid in doubt schema  and mark the doubt inactive 
